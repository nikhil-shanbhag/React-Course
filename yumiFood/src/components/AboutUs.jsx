...
const AboutUs = () => {
  return (
    <div className="text-gray-600 body-font w-[80%] mx-auto">
      <div className="px-4">
        <h2 className="sm:text-4xl text-3xl mb-4 font-medium text-gray-900 mt-8">
          Driving the force of{" "}
          <span className="text-yellow-400">assortment</span>
        </h2>
      ...
      <div className="mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h2 className="sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
            Who are we?
          </h2>
